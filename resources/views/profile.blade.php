    ...
    <div class="mx-auto max-w-7xl px-6 py-4">
        <div class="flex items-center justify-between">
            ...
            <form action="{{ route('auth.logout') }}" method="post">
                @csrf
                <button type="submit" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition duration-200 cursor-pointer">
                    Sign out
                </button>
            </form>
        </div>
...
<main class="flex-1 flex items-center justify-center px-6 py-12">
    <div class="max-w-5xl mx-auto px-6 py-12">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-gray-600">Authorization code + verifier exchanged for tokens</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-8">
            ...
            <p class="text-gray-600 mb-6">Below is the authentication data stored in your session after a successful PKCE flow:</p>
